(function($angular) {
    ...
    var appImgur = $angular.module('ngImgur', []);

    /**
     * @constant imgurOptions
     * @type {Object}
     */
    appImgur.constant('imgurOptions', {
     ...
     */
    appImgur.service('imgur', ['$window', '$http', '$q', 'imgurOptions', function ImgurService($window, $http, $q, imgurOptions) {
         ...
         * @return {$q.promise}
         */
        service.upload = function (imageData) {
        ...
        service.send = function send(imageData) {
            ...
            reader.onload = function (event) {
                ...
                var dataModel   = { image: base64Data };
