...
MessageCenterModule.provider("$messageCenterService", function() {
    var _this = this;
    _this.options = {};
        ...
        add: function (type, message, options) {
          ...
          if ($angular.isDefined(options.timeout)) {
            messageObject.timer = $timeout(function () {
              messageObject.type += ' ng-hide-remove';
              $timeout(function (){
                messageObject.close();  
              },3000);
            }, options.timeout);
    ...
    MessageCenterModule.directive('mcMessages', ['$rootScope', 'messageCenterService', function ($rootScope, messageCenterService) {
