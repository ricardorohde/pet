(function($angular) {
	 ...
	 * Cliente Service
	 */ 
	$angular.module('app').service('clienteService',['$http','utilService', function ($http,$utilService) {
	    
	    var service = {};
	    var error = {};
	    
	    service.listacliente = [];
	    service.listatodosclientes = [];
	    service.cliente = {};
	    
	    service.findCliente = function(dados, callback) {
